...
A térkép egy lokális cache-bõl töltõdik be, mely Budapest környékét nagy felbontásban, Magyarországot közepes felbontásban tartalmazza, így a terepen, a program mûködõképes lesz internet kapcsolat nélkül is. Ha szükséges újabb területeket hozzáadni, az a mellékelt Demo.WindowsForms.exe programmal könnyen megtehetõ, a generált könyvtárstruktúrával felül kell írni a program által használtat, bõvebb információ a \sectref{gmap} fejezetben található.



\subsection{Tervezés képernyõ}

Egyik megoldandó feladatom volt, hogy lehetõséget biztosítsak útvonal feltöltésére is, ezt hivatott a tervezés képernyõ megvalósítani. Ezen a felületen dupla egérkattintással rakható le új útvonalpont, mely hosszan nyomva szerkeszthetõ, jobb kattintással törölhetõ.
