...
Felmerülhet a kérdés, hogy a feltöltés ezzel a protokollal elég hibatûrõ-e, mivel a fogadás protokollja is hasonlóan van megoldva, így elégségesnek tûnik. Mivel ha a küldés megfelelõen lezajlott, kapunk visszajelzést, ha nem akkor lehetõség van az újbóli elküldésre.
...
Lehetõség nyílik a fogadott csomagok hexadecimális formában történõ megjelenítése, így az operátor alacsony szinten megbizonyosodhat a kapcsolat létrejöttében, mivel láthatja a csomagok felépítését. Ha a fejléc a csomag elején látszódik, akkor mûködnie kell a további dekódolásnak, melyet a többi nézet használ fel. Ha nem látna itt adatokat, akkor ellenõrizheti, hogy valóban jó portot illetve adatsebességet választott-e ki.
...
\subsection{GDI+}
\cite{bib:gdi} A GDI (Graphic Device Interface) egy Windows API, célja,az alkalmazások számára grafikus támogatást biztosítani. Olyan eljárások és függvények gyûjteménye, amelyek nagyban megkönnyítik a grafikus elemek (görbék, alakzatok, BMP képek) megjelenítését, szövegek kiíratását. A GDI+ ennek továbbfejlesztett változata, mely képes ezen elemek manipulációjához alkalmas mátrixtranszfomációkat kezelni. Továbbá egyéb képformátumok kezelésével bõvítették.
