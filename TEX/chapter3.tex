...
chapter2 és 3 közé megvalósítás bemutatás , mérési erdemények

%----------------------------------------------------------------------------
\chapter{Megtervezett mûszaki alkotás értékelése, kritikai elemzése, továbbfejlesztési leehtõségek}
%----------------------------------------------------------------------------
...
\section{RS232}
A modembõl érkezõ adatokat soros porton keresztül fogadja a program, a tesztkörnyezet felállításához HIL adatok szolgáltak. A küldött log fájlokat egy programmal beolvasom és egy \cite{bib:null}null-modem segítségével soros porton keresztül küldöm a megfelelõ portra. 
