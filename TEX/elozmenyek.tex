...
\begin{figure}[H]
	\centering
	\resizebox{15cm}{!}{
		\includegraphics{figures/ardu_plan.png}}
	\caption{}
	\label{fig:ardu_plan}
\end{figure}
...
Itt számos beállítás közül lehet választani, lehetõség van a nyelv és mértékegységek kiválasztására, naplózás sûrûségének meghatározására.
Egy másik oldalon az aktuális jármûvet lehet beállítani, mivel más adatok fontosak egy földi és egy légi jármû esetében, továbbá a kommunikációs protokoll is változó.
