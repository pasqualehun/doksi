...
Ez a program \cite{bib:qground} nyílt forráskódú és a MAVLink protokollt használja a csatlakoztatott eszközzel történõ kommunikációra. Érdekesség, hogy a program a repülõgép aktuális pozícióját a \figref{qground} látható módon 3D-ben is meg tudja jeleníteni és videókép fogadására is alkalmas. Az útvonalpontok szerkesztése felszállás után is lehetséges. A protokollnak köszönhetõen a program képes 255 jármû egyidejû kezelésére.
\begin{figure}[H]
	\centering
	\resizebox{15cm}{!}{
...
\begin{table}[H]
	\begin{center}
			...
			%	Paparazzi 			& ?, nem nyílt						&			+							 &				-					   & 	-									\\ \hline
				...
				\hline
				\textbf{Program}    	& \textbf{Ardupilot}			&\textbf{Paparazzi}	 &\textbf{MicroPilot}		& \textbf{QGround} & 	\textbf{HappyKillMore}				  	\\ 
				          						&           							& 		            	 &             				 &  \textbf{Control}&		          		\\ \hline
