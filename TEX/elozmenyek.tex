...
A fentebb bemutatott földi irányító állomások tulajdonságait a \tabref{compare} táblázatban összefoglaltam. 

Látható, hogy megoldások forráskódja elég változatos a választott nyelv tekintetében. A nyílt forráskódúak az összes manapság használatos programozási nyelvet felhasználják. Ezek tanulmányozásával lehetõség van ötleteket meríteni a tervezéshez és megvalósításhoz.

Az összesre jellemzõ, hogy a repülõgép pozíciója valamilyen térképen kerül megjelenítésre. Általában a fõképernyõn a sebesség és a magasság adatok mindig látszódnak, így az elkészítendõ felületre célszerû egy térképes megjelenítést és a legfontosabb információk kijelzését megoldani. 
...
A MicroPilot program (\sectref{micropilot} fejezet) elsõdleges funkciója a repülõgép távvezérléséhez kapcsolatos információk kijelzése, ezért az operátor figyelmét különféle figyelmeztetõ üzenetekkel hívja fel (elõre beállított tiltott légtér). Ilyen figyelemfelkeltõ üzeneteket érdemes használni hibadetektálás eredményének kijelzésére.
	...
	\begin{center}
			...
			%	Paparazzi 			& ?, nem nyílt						&			+							 &				-					   & 	-									\\ \hline
				...
				\textbf{Program}    	& \textbf{Ardupilot}			&\textbf{Paparazzi}	 &\textbf{MicroPilot}		& \textbf{QGround} & 	\textbf{HappyKillmore}				  	\\ 
				          						& \textbf{MissionPlanner}         							& 		            	 &             				 &  \textbf{Control}&		          		\\ \hline
