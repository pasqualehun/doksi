...
A kommunikáció csatornánként 2 db modem segítségével történik, a modemek egymás közt vezeték nélkül csatlakoznak, felhasználó oldalon soros portot biztosítanak. Így az elkészítendõ programnak elég csak egy soros portra csatlakoznia. Az elõre meghatározott átviteli értékek alapján képes fogadnia  repülõrõl érkezõ csomagokat.

\section{Redundáns jelek feldolgozása}

A redundanciából következõen külön, külön kell kezelni a 2 párhuzamos csatornán kapott adatokat. Mivel aszinkron módon érkeznek a csomagok, így kettõ tároló kell, mely a legutóbb küldöttet tárolja.
